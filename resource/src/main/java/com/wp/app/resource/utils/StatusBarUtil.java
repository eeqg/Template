...
public class StatusBarUtil {
	 ...
	 * 设置状态栏颜色
	 *
	 * @param activity 需要设置的 activity_wxcode
	 * @param color    状态栏颜色值
	 */
	 ...
	 *
	 * @param activity       fragment 对应的 activity_wxcode
	 * @param needOffsetView 需要向下偏移的 View
	 */
	...
	public static void setLightMode(Activity activity) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			// activity_wxcode.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
	...
	public static void setDarkMode(Activity activity) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			// activity_wxcode.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
			View decorView = activity.getWindow().getDecorView();
			if (decorView != null) {
				int vis = decorView.getSystemUiVisibility();
				vis |= View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR;
